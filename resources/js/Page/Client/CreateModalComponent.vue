        ...
        <form @submit.prevent="storeClient">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">{{ $t('create_client_modal_input_name') }}</label>
                    ...
                    <div class="mb-3">
                        <label for="initiative_name" class="form-label">{{ $t('create_client_modal_input_initiative_name') }}</label>
                    ...
                    <div class="mb-3">
                        <label for="ballpark_development_hours" class="form-label">{{ $t('create_client_modal_input_ballpark_development_hours') }}</label>
