        ...
        <form @submit.prevent="updateOpportunity">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="client_name" class="form-label">{{ $t('edit_opportunity_modal_select_client_name')
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">{{ $t('edit_opportunity_modal_input_name') }} <strong
