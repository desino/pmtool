<template>
    <div class="row mt-3">
        ...
        <div class="col-md-4" v-if="showInput">
            <input type="text" @blur="handleBlur" @keyup.enter="handleEnter" v-model="formData.name" autofocus class="form-control" id="name" :placeholder="$t('solution_design.add_section_input_placeholder')">
        </div>
    </div>
</template>
