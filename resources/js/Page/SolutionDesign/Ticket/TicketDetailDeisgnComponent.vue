            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="m-0">{{ ticketData.composed_name }}
                        <span>
                            <input type="checkbox" v-model="showTicketDropdown" class="btn-check" id="btn-check"
                                autocomplete="off">
                            <label class="btn btn-desino-outline fw-bold border" for="btn-check">
                                <i class="bi"
                                    :class="{ 'bi-pencil-square': !showTicketDropdown, 'bi-x-lg text-danger': showTicketDropdown }">
                                </i>
                            </label>
                        </span>
                    </h3>
                            ...
                            <div class="card-body p-2 px-4 text-left d-flex align-items-center">
                                <div class="w-100 lh-1">
                                    ...
                                    <span class="badge rounded-3 bg-desino text-white">{{
                                        ticketData.functional_owner }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body p-2 px-4 text-left d-flex align-items-center">
                                <div class="w-100 lh-1">
                                    ...
                                    <span class="badge rounded-3 bg-info-subtle text-info">{{
                                        ticketData.technical_owner }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6 my-2">
                <div class="col-md-12 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p> Describe & Document the change done for the client. Use print-screen so that the
                                client
