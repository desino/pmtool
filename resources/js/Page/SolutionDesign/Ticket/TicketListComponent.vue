        ...
        <ul class="list-group list-group-flush mb-3 mt-2">
            <li class="list-group-item bg-desino text-white border-0 rounded-top px-1 py-3">
                <div class="row w-100 align-items-center">
                    ...
                    <div class="col-md-3 col-lg-3 col-xl-2 fw-bold small d-none d-md-block text-center">
                        {{ $t('ticket.list.column_task_status') }}
                    </div>
                    <div class="col-md-3 col-lg-3 col-xl-2 fw-bold small d-none d-md-block text-end text-xl-center">
                        {{ $t('ticket.list.column_project') }}
                    </div>
                    <div class="col-xl-1 fw-bold small d-none d-xl-block text-start">
                        {{ $t('ticket.list.estimation_hours') }}
                    </div>
                    <div class="col-xl-1 fw-bold small d-none d-xl-block">
                        {{ $t('ticket.list.current_owner') }}
                    </div>
                    <div class="col-xl-1 fw-bold small d-none d-xl-block text-lg-end">
            ...
            <li v-for="(task, index) in tasks" v-if="tasks.length > 0" :key="task.id"
                ...
                <div class="row g-1 w-100 align-items-center">
                    ...
                    <div class="offset-1 col-5 offset-md-0 col-md-3 col-lg-3 col-xl-2 text-center py-2 py-lg-0">
                    ...
                    <div class="col-5 col-md-3 col-lg-3 col-xl-1 py-2 py-lg-0">
            ...
            <li v-else class="border border-top-0 list-group-item px-0 py-1 list-group-item-action">
                <div class="fw-bold fst-italic text-center w-100">{{ $t('ticket.list.not_ticket') }}
                </div>
            </li>
        </ul>
