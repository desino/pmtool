...
return [
    'auth' => [
        ...
        'login_credentials_does_not_match' => 'Invalid Credentials.',
        ...
        'office365_login_success' => 'Logged In Successfully with azure.',
    ...
    'client' => [
        'store_success' => 'Client created successfully.',
    ],
    'error' => [
